...
Every failure inside qodo-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`qodo.cli._output`,
...
# Exit-code policy. Documented in ``qodo-cli learn`` output.
# 0      = success
